...
# gpus
cfg.gpus = list(range(5))
# if load the pretrained network
cfg.resume = True                  # lhh modify
cfg.use_mps_net = False
# epoch
cfg.ep_iter = -1
cfg.save_ep = 100
cfg.save_latest_ep = 5
cfg.eval_ep = 50                     # lhh modify : 100
...
def parse_cfg(cfg, args):
    ...
    cfg.trained_model_dir = os.path.join(cfg.trained_model_dir, cfg.task,
                                         cfg.exp_name)
    cfg.train_log_dir = os.path.join(cfg.record_dir, cfg.task, cfg.exp_name, 'log_record')
    cfg.record_dir = os.path.join(cfg.record_dir, cfg.task, cfg.exp_name, 'loss_record')

    cfg.evaluate_log_dir = os.path.join(cfg.result_dir, cfg.task, cfg.exp_name, 'result_tensorboard')
    cfg.result_dir = os.path.join(cfg.result_dir, cfg.task, cfg.exp_name, 'result_file')
